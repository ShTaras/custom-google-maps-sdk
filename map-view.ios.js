...
var IndoorDisplayDelegateImpl = (function (_super) {
...
var MapViewDelegateImpl = (function (_super) {
    ...
    MapViewDelegateImpl.prototype._layoutRootView = function (rootView, parentBounds) {
        ...
        var widthSpec = utils_1.layout.makeMeasureSpec(width, utils_1.layout.EXACTLY);
        var heightSpec = utils_1.layout.makeMeasureSpec(height, utils_1.layout.EXACTLY);
...
var MapView = (function (_super) {
    ...
    function MapView() {
        ...
        _this._indoorDelegate = IndoorDisplayDelegateImpl.initWithOwner(new WeakRef(_this));
        _this.updatePadding();
        return _this;
    }
...
var Marker = (function (_super) {
    ...
    Marker.getIconForColor = function (hue) {
        var hueKey = hue.toFixed(8);
        if (!Marker.cachedColorIcons[hueKey]) {
            var icon = GMSMarker.markerImageWithColor(UIColor.colorWithHueSaturationBrightnessAlpha(hue, 1, 1, 1));
