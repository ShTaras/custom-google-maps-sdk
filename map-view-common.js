...
var MapViewBase = (function (_super) {
    ...
    MapViewBase.prototype.notifyMarkerInfoWindowClosed = function (marker) {
    ...
    MapViewBase.prototype.notifyBuildingFocusedEvent = function (indoorBuilding) {
        var args = { eventName: MapViewBase.indoorBuildingFocusedEvent, object: this, indoorBuilding: indoorBuilding };
        this.notify(args);
    };
    MapViewBase.prototype.notifyIndoorLevelActivatedEvent = function (activateLevel) {
        var args = { eventName: MapViewBase.indoorLevelActivatedEvent, object: this, activateLevel: activateLevel };
        this.notify(args);
    };
